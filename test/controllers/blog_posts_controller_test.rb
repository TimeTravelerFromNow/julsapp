...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference("BlogPost.count") do
      post blog_posts_url, params: { blog_post: { description: @blog_post.description, kind: @blog_post.kind, status: @blog_post.status, title: @blog_post.title } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { description: @blog_post.description, kind: @blog_post.kind, status: @blog_post.status, title: @blog_post.title } }
